...
do
    echo ../../datacenter/htsim_ndp_incast_shortflows_nack_offload -o incast${cwnd}_q8_c${conns}_f${flowsize} -conns $conns -nodes 8192 -cwnd ${cwnd} -q 8 -strat perm -flowsize $flowsize
    ../../datacenter/htsim_ndp_incast_shortflows_nack_offload -o incast${cwnd}_q8_c${conns}_f${flowsize} -conns $conns -nodes 8192 -cwnd ${cwnd} -q 8 -strat perm -flowsize $flowsize > ts_incast${cwnd}_q8_c${conns}_f${flowsize}
	python3 ./process_data_incast_conns.py incast${cwnd}_q8_c${conns}_f${flowsize} $conns $flowsize $cwnd ndp
